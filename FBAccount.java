class FBAccount{
	...
	createFBAccount("Sanjana","NH",30,"November",2003,"Female","sanjananh3210@gmail.com","jjbybdxgfegfn");
	}
	
	static void createFBAccount(String firstName,String lastName,int dobDay,String dobMonth,int dobYear,
