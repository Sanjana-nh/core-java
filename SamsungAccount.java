class SamsungAccount{
	...
	{
	createSamsungAccount("sanjananh3210@gmail.com","Finesse2929","Finesse2929","Sanjana","NH","November",30,2003);
	}
	
	static void createSamsungAccount(String userEmail,String password,String confirmPass,String firstName,
